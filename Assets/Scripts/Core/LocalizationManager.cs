        ...
        {
            {
                ...
                new Dictionary<string, string>
                {
                    ...
                    { "howTo.step1.title", "Tutorial 1" },
                    { "howTo.step1.body", "The two highlighted tiles are adjacent. Tap on either one to make a direct match where they become a path." },
                    { "howTo.step2.title", "Tutorial 2" },
                    { "howTo.step2.body", "Matching tiles can also be cleared when they share the same row or column with a path in between. Tap either highlighted tile to make another match." },
                    { "howTo.step3.title", "Tutorial 3" },
                    { "howTo.step3.body", "Now try a drag move. Drag the highlighted tile along the path to match it with its partner." },
                    { "howTo.step4.title", "Tutorial 4" },
                    { "howTo.step4.body", "Finally, you can also drag and move a tile so it pushes connected tiles along the path. Try to match the two highlighted tiles." },
                    { "howTo.undo.title", "Undo" },
                    { "howTo.undo.body", "Undo reverses your last move. You may also undo your item moves. Tap the Undo button to bring back the pair you just cleared." },
                    { "howTo.shuffle.title", "Shuffle" },
                    { "howTo.shuffle.body", "Shuffle rearranges the remaining board when you want a fresh look. Try it out!" },
                    { "howTo.swapButton.title", "Swap" },
                    { "howTo.swapButton.body", "Swap lets you exchange two tiles. Tap the Swap button, then we will use it on the highlighted pair." },
                    { "howTo.swapTiles.title", "Swap Tiles" },
                    { "howTo.swapTiles.body", "Swap the two highlighted tiles to continue." },
                    { "howTo.complete.title", "Tutorial Completed" },
                    { "howTo.complete.body", "You have completed the tutorial. Your goal is to clear the whole board. Note that some boards are unsolvable.\nTap anywhere to return to the main menu." },

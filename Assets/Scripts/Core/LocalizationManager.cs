        ...
        {
            {
                ...
                new Dictionary<string, string>
                {
                    ...
                    { "howTo.step3.title", "Guide 3" },
                    { "howTo.step3.body", "Now try a drag move. Drag the highlighted tile along the path to match it with its partner." },
                    { "howTo.step4.title", "Guide 4" },
                    { "howTo.step4.body", "You can also drag and move a tile so it pushes connected tiles along the path. Try to match the two highlighted tiles." },
                    { "howTo.undo.title", "Item - Undo" },
                    { "howTo.undo.body", "Undo rewinds your last move. You may also undo your item moves. Tap the Undo button to bring back the pair you just cleared." },
                    { "howTo.shuffle.title", "Item - Shuffle" },
                    { "howTo.shuffle.body", "Shuffle rearranges the remaining board when you want a fresh look. Try it out!" },
                    { "howTo.swapButton.title", "Item - Swap" },
                    { "howTo.swapButton.body", "Swap lets you exchange two tiles. Tap the Swap button, then we will use it on the highlighted pair." },
                    { "howTo.swapTiles.title", "Item - Swap" },
                    { "howTo.swapTiles.body", "Swap the two tiles to continue." },
                    { "howTo.complete.title", "Tutorial Completed" },
                    { "howTo.complete.body", "You have completed the tutorial. Your goal is to clear the whole board. Note that some boards are not solvable.\nTap anywhere to return to the main menu." },
